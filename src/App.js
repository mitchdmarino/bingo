    ...
    <div className="App">
      <div className='header'>
        ...
        <p>Hello! <br></br><br></br>
          ...
          Please note: this site does not save your uploaded images or information. So, if you accidentally refresh the page, you will not have your Bingo squares’ photos saved and will have to re-add them. We recommend to snap and save the bingo square photos onto your camera roll first, then upload them onto the bingo square once you have 5 bingo squares ready to go! <br></br><br></br>

          Once you have uploaded all 5 bingo square photos and know you’ve gotten bingo in a row, share this on #wt-officebingo Slack channel and Dija will check! First person to get bingo wins a prize! For any issues, contact Dija. <br></br><br></br>
